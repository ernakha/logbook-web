        ...
        <div class="card w-100 shadow-sm">
            <div class="card-header card-header-custom">
                <h5 class="mb-0 text-white">
                    Edit Data BKPH {{ $daerahUser }}
                </h5>
            </div>

            <div class="card-body p-4">

                <form action="{{ route('adminbkph.update', $bkph->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_rph" id="nama_rph"
                            ...
                            value="{{ old('nama_rph', $bkph->nama_rph) }}" required>
                        @error('nama_rph')
                        ...
                        <select name="pegawai_id" id="pegawai_id"
                            ...
                            @foreach ($pegawai as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('pegawai_id', $bkph->pegawai_id) == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_polhuter" id="jumlah_polhuter"
                            ...
                            value="{{ old('jumlah_polhuter', $bkph->jumlah_polhuter) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="telp_kantor" id="telp_kantor"
                            ...
                            value="{{ old('telp_kantor', $bkph->telp_kantor) }}" required>
                        @error('telp_kantor')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
